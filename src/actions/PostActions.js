...
export const TYPES = {
  ...
  GET_ACTIVE_GIVEAWAY_PAGINATION_REQUEST:
    'GET_ACTIVE_GIVEAWAY_PAGINATION_REQUEST',
  GET_ACTIVE_GIVEAWAY_PAGINATION_SUCCESS:
    'GET_ACTIVE_GIVEAWAY_PAGINATION_SUCCESS',
  ...
  GET_ALL_EXCLUSIVE_POST_PAGINATION_REQUEST:
    'GET_ALL_EXCLUSIVE_POST_PAGINATION_REQUEST',
  GET_ALL_EXCLUSIVE_POST_PAGINATION_SUCCESS:
    'GET_ALL_EXCLUSIVE_POST_PAGINATION_SUCCESS',
  GET_ALL_EXCLUSIVE_POST_PAGINATION_ERROR:
    'GET_ALL_EXCLUSIVE_POST_PAGINATION_ERROR',
...
export const searchAllPost = (searchWord, userID) => async dispatch => {
  ...
  try {
    const searchAllPostData = await PostController.searchAllPost(
      searchWord,
      userID
    );
...
export const commentOnPost =
  (postId, userId, commentBody, commentOwnerId) => async dispatch => {
    dispatch(commentOnPostRequest());
    // try {
    const comment = await PostController.commentOnPost(
      postId,
      userId,
      commentBody,
      commentOwnerId
...
export const editComment =
  (id, userId, commentBody, commentIndex) => async dispatch => {
...
export const unFollowUser =
  (unFollowerId, followId, type) => async dispatch => {
