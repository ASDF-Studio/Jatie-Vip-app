...
import { CustomLoader, HorizontalLine, Icon, StatusNavigatorBar } from '@/components';
...
import { getAllActiveGiveaway, getAllPastGiveaway, TYPES } from '@/actions/PostActions';
...
export function Giveaway({ navigation }) {
  ...
  const pastDataLoading = useSelector(state => isLoadingSelector([TYPES.GET_PAST_GIVEAWAY], state))
