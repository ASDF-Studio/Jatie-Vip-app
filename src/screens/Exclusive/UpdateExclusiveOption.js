import { createExclusivePost, getAllExclusivePost, TYPES, updateExclusivePost } from '@/actions/PostActions';
...
export default function UpdateExclusiveOption({ navigation, route }) {
    ...
    useEffect(() => {
        setVipOnly(finalData?.vipOnly)
        setPinPost(finalData?.isPinned)
        setSchedulePost(finalData?.schedulePost)
    }, [])
