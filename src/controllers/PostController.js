...
export class PostController {
  ...
  static async searchUserByUserNameAPI(searchWord, loggedInUserId) {
    return new Promise((resolve, reject) => {
  ...
  static async pinPost({ postId }) {
    return new Promise((resolve, reject) => {
      const endpoint = API_BASE_URL + API_END_POINTS.CREATE_PINNED_POST;
      const body = JSON.stringify({
        postId,
      });
      HttpClient.post(endpoint, body)
  ...
  static async unPinPost({ postId }) {
    return new Promise((resolve, reject) => {
      const endpoint = API_BASE_URL + API_END_POINTS.REMOVE_PINNED_POST;
      const body = JSON.stringify({
        postId,
      });
      HttpClient.post(endpoint, body)
